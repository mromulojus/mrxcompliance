  ...
  useEffect(() => {
    ...
    const createNebula = () => {
      ...
      const material = new THREE.ShaderMaterial({
        uniforms: {
          time: { value: 0 },
          color1: { value: new THREE.Color(0x1a365d) },
          color2: { value: new THREE.Color(0x2d3748) },
          opacity: { value: 0.2 }
        },
        vertexShader: `
          varying vec2 vUv;
    ...
    const createMountains = () => {
      ...
      const layers = [
        { distance: -50, height: 60, color: 0x1a202c, opacity: 1 },
        { distance: -100, height: 80, color: 0x2d3748, opacity: 0.8 },
        { distance: -150, height: 100, color: 0x4a5568, opacity: 0.6 },
        { distance: -200, height: 120, color: 0x718096, opacity: 0.4 }
      ];
      ...
      const material = new THREE.ShaderMaterial({
        ...
        fragmentShader: `
          ...
          void main() {
            ...
            vec3 atmosphere = vec3(0.2, 0.4, 0.6) * intensity;
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const cameraPositions = [
        { x: 0, y: 30, z: 300 },    // Section 0 - PLAN
        { x: 0, y: 40, z: -50 },     // Section 1 - CHECK
        { x: 0, y: 50, z: -700 }       // Section 2 - CONTROL
      ];
    ...
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div className="hero-content cosmos-content">
        ...
        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
          <p className="subtitle-line">
            Planeje com precisão estratégica
          </p>
          <p className="subtitle-line">
      ...
      <div className="scroll-sections">
       {[...Array(2)].map((_, i) => {
          ...
          const subtitles = {
            0: {
              line1: 'Planeje com precisão estratégica',
              line2: 'transformando visão em resultados'
            },
            1: {
              line1: 'Monitore cada etapa do processo',
              line2: 'garantindo qualidade e conformidade'
            },
            2: {
              line1: 'Controle total sobre operações',
              line2: 'com eficiência e governança'
            }
          };
